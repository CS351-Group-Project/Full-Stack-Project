...
-> We are planning to use PostgreSQL, because it provides great RDBMS features, is also a reliable performer.
...
-> Google Maps API: We will use Google Maps API for location of nearby temples and also for directions.
...
-> Also, we might use OAuth for google-sign in, if needed.

**Q6: How will you store and protect sensitive user data (e.g., passwords, tokens)?**

-> We plan on hasHing the passwords with bcrypt before it gets stored.
